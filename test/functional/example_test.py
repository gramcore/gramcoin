...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GRAMTestFramework
    pass

class ExampleTest(GRAMTestFramework):
    # Each functional test is a subclass of the GRAMTestFramework class.
    ...
    def custom_method(self):
        ...
        GRAMTestFramework class so other tests can use it."""
