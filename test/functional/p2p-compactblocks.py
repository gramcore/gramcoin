...
# TestNode: A peer we use to send messages to gramd, and store responses.
...
class CompactBlocksTest(GRAMTestFramework):
    ...
    # This test actually causes gramd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gramd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gramd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # gramd will not send blocktxn responses for blocks whose height is
