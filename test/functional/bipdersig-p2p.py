...
class BIP66Test(GRAMTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gramd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gramd produces more specific reject
            # reasons.
