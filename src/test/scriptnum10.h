...
#ifndef GRAM_TEST_SCRIPTNUM10_H
#define GRAM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GRAM Core 0.10.0, for cross-comparison.
 */
public:
