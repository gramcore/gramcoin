...
#ifndef GRAM_QT_GRAMUNITS_H
#define GRAM_QT_GRAMUNITS_H
...
/** GRAM unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GRAMUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GRAMUnits(QObject *parent);

    /** GRAM units.
      @note Source: https://en.gram.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GRAM,
...
typedef GRAMUnits::Unit GRAMUnit;

#endif // GRAM_QT_GRAMUNITS_H
