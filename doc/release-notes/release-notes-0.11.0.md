...
defaults to 0.00001. This will cause transactions with fewer Bitcoin/kB fee to be
...
the user specifies 550MB, once that level is reached the probitcoin will begin 
