...
This document provides guidelines for internationalization of the GRAM Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gram_en.ts` remains unchanged.
